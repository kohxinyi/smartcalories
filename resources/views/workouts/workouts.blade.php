...
<!-- header -->
<div class="container">
  <h2 class="display-1">My Exercises</h2>
</div>
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-3/2">
                ...
                <select class="form-control" name="intensity" value="{{old('intensity', '')}}" id="intensity">
            ...
            <div class="col">
              ...
              <select class="form-control" name="duration" value="{{old('duration', '')}}" id="duration">
            ...
            <div class="col">
              <button type="submit" class="btn btn-primary mt-4"><i class="bi bi-plus"></i> New Exercise</button>
            </div>
          </div>
        </div>
      <!-- /.card-body -->
