  ...
  <div class="card-body">
    ...
    <div class="row">
      <div class="col">
        ...
        <input type="date" class="form-control" name="goal_time" value="{{old('goal_time', '')}}" id="goal_time" placeholder="Enter date..">
        @error('goal_time')
      ...
      <div class="col">
        ...
        <input type="number" class="form-control" name="cal" value="{{old('cal', '')}}" id="cal" placeholder="Enter calories..">
        @error('cal')
          <div class="alert alert-danger">{{$message}}</div>
        @enderror
      </div>
      <div class="col">
        ...
        <input type="number" class="form-control" name="cal_min" value="{{old('cal_min', '')}}" id="cal_min" placeholder="Enter calories..">
        @error('cal_min')
          <div class="alert alert-danger">{{ $message }}</div>
        @enderror
      </div>
      <div class="col">
        ...
        <input type="number" class="form-control" name="weight" value="{{old('weight', '')}}" id="weight" placeholder="Enter goals..">
        @error('weight')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
      </div>
      <div class="col">
        <button type="submit" class="btn btn-primary mt-4">Create New Goals</button>
      </div>
    </div>
  </div>
<!-- /.card-body -->
